...
public class ApproveScheduleDoctor extends HttpServlet {
    ...
    /**
     * Processes requestuests for both HTTP <code>GET</code> and <code>POST</code>
     * methods.
     *
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
        if (doctorScheduleDao.ApproveSchedule(id)){
            response.sendRedirect(request.getContextPath() + "/admin/doctor-schedule-control?id="+id);
        }}catch(Exception e){

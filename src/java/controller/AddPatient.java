 ...
 * @author ADMIN
 */
@WebServlet(name = "AddPatient", urlPatterns = {"/add_patient"})
public class AddPatient extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        int pId = PatientService.generateID();
        ...
        Patient p = new Patient(pId, fullName, gender, dob, email, phone, address, pass);
        PatientService.patientRegister(p);

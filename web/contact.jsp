...
<head>
    ...
    <title>Về Chúng Tôi - MEDINOVA</title>
    ...
    <body>
            ...
            <div class="container py-5">
                <div class="row gx-5">
                    <div class="col-lg-6 mb-5 mb-lg-0">
                        ...
                        <p class="text-white mb-5">Email: benhvienmedinova@gmail.com </p>
        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="text-center mb-3"> Nếu có thắc mắc, vui lòng liên hệ qua email benhvienmedinova@gmail.com hoặc điền vào mẫu dưới đây.</div>
                    <div class="card">
                        <div class="card-body">
